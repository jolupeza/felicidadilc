...
class HTML2PDF_myPdf extends TCPDF
{
     ...
     * @param bool   $diskcache   if TRUE reduce the RAM memory usage by caching temporary data on filesystem (slower).
     */
     ...
     *
     * @param bool $page display the page number
     * @param bool $date display the date
     * @param bool $hour display the hour
     * @param bool $form display a warning abour forms
     */
     ...
     *
     * @param float $y
     * @param bool  $resetx Reset the X position
     * @param bool  $rtloff NOT USED
     */
     ...
     * @param float $x
     * @param float $y
     * @param bool  $trans apply transformation
     */
     ...
     * @param bool  $drawFirst, true => add the first point
     * @param bool  $trans      apply transformation
     */
     ...
     * @param bool  $l     large-arc-flag
     * @param bool  $s     sweep-flag
     * @param bool  $trans apply transformation
     */
     ...
     * @param float &$x
     * @param float &$y
     * @param bool  $trans true => convert into PDF unit
     *
     * @return bool
     */
     ...
     * @param int      $sizeTitle     Font size for hthe Title
     * @param int      $sizeBookmark  Font size for the bookmarks
     * @param bool     $bookmarkTitle Bookmark the Title
     * @param bool     $displayPage   Display the page number for each bookmark
     * @param int      $page          draw the automatic Index on a specific Page. if null => add a page at the end
