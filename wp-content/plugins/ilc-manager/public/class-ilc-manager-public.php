<?php
/**
 * The Ilc Manager Public defines all functionality for the public-facing
 * sides of the plugin.
 */
...
class Ilc_Manager_Public
{
    ...
    public function display_post_meta_data($content)
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)).'admin/partials/ilc-manager.php';
